...
export default function Contact({ setActivePage }: ContactProps) {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const response = await fetch("https://formsubmit.co/ajax/Abbasendodontics@gmail.com", {
        method: "POST",
        headers: {
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-16 items-start">
            ...
            <div className="lg:col-span-8 space-y-8">
              ...
              <AnimatedSection direction="right" className="space-y-3">
                ...
                <h1 className="font-display text-4xl font-black text-deep-navy tracking-tight">
                  Book an Appointment
                </h1>
                <p className="text-base text-slate-500 leading-relaxed font-sans font-light">
                  Please fill out the form to request a consultation, and our team will get back to you shortly.
                </p>
              </AnimatedSection>
              ...
              {isSubmitted ? (
                <AnimatedSection direction="up" className="p-10 rounded-3xl bg-brand-blue-light/40 border border-brand-blue/15 space-y-8 text-center shadow-premium-lg relative overflow-hidden">
                  ...
                  <div className="space-y-3">
                    <h3 className="font-display font-black text-3xl text-deep-navy">Message Sent Successfully</h3>
                    <p className="text-base text-slate-600 leading-relaxed max-w-xl mx-auto font-sans font-light">
                      Thank you for reaching out to Aurus Dental Studio. We have received your inquiry and our team will contact you shortly to confirm your booking.
                    </p>
                  </div>
                ...
                <AnimatedSection direction="up" className="bg-white p-8 sm:p-10 rounded-3xl border border-slate-100 shadow-premium-lg">
                  <form id="dental-intake-form" onSubmit={handleSubmit} className="space-y-8">
                    ...
                    {/* Message / Brief */}
                    <div className="space-y-2.5">
                      <label htmlFor="message" className="text-[11px] font-mono font-bold text-deep-navy uppercase tracking-widest block">Your Message / Dental Concerns *</label>
                      <textarea
                        id="message"
                        name="message"
                        rows={6}
                        ...
                        onChange={handleInputChange}
                        placeholder="Describe your dental concerns, preferred appointment dates, or questions here..."
                        className={`w-full px-4.5 py-3.5 bg-soft-gray border rounded-xl text-sm transition-all focus:outline-none focus:ring-4 focus:ring-brand-blue/5 ${
              ...
              <div className="space-y-6">
                ...
                >
                  ...
                  <div className="space-y-1.5">
                    ...
                    <p className="text-xs sm:text-sm text-slate-500 leading-relaxed font-sans font-light">
                      <span className="font-semibold text-slate-700 block mb-1">Saifee Smiles Multispeciality Dental Clinic</span>
                      5C, Shamji Morarji building, Champsi Bhimji Rd, Thakkar Estate, Mazgaon, Mumbai, Maharashtra 400010
                    </p>
                  </div>
                </AnimatedSection>
                ...
                >
                  ...
                  <div className="space-y-1.5">
                    ...
                    <p className="text-xs sm:text-sm text-slate-500 font-sans font-light">
                      <span className="font-bold text-slate-700">Phone:</span> +91 98208 54665
                    </p>
